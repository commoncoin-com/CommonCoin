...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the CommonCoin Core repository on GitHub"),
        tr("Services that claim to double your commoncoins are always ponzi schemes")
    };
