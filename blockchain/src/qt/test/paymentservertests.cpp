...
// Copyright (c) 2020-2023 The CommonCoin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // CommonCoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for CommonCoin (as there is no actual maximum coins)
