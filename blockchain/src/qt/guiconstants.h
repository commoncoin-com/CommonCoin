...
#define QAPP_ORG_NAME "CommonCoin"
#define QAPP_ORG_DOMAIN "commoncoin.org"
#define QAPP_APP_NAME_DEFAULT "CommonCoin-Qt"
#define QAPP_APP_NAME_TESTNET "CommonCoin-Qt-testnet"
