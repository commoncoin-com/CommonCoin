...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s commoncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  commoncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded commoncoin transaction") + "\n" +
              "  commoncoin-tx [options] -create [commands]   " + _("Create hex-encoded commoncoin transaction") + "\n" +
              "\n";
