...
// Copyright (c) 2022-2024 The CommonCoin Core developers
...
{
    const char* pszTimestamp = "CommonCoin - The People's Cryptocurrency";
...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in CommonCoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to CommonCoin values
        ...
        consensus.nMinimumChainWork = uint256S("0x00"); // Start from 0 for fresh chain

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00"); // Disable assume-valid check for fresh chain
        ...
        genesis = CreateGenesisBlock(1780488986, 3426683, 0x1e0ffff0, 1, 88 * COIN);
        ...
        vSeeds.push_back(CDNSSeedData("129.159.233.153", "129.159.233.153"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1780488987, 36396, 0x1e0ffff0, 1, 88 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1780488986, 8, 0x207fffff, 1, 88 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
