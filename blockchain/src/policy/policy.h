...
/** Recommended transaction fee by CommonCoin Core developers
  *
 ...
 *
 *  CommonCoin:    Increment mempool limits and accept RBF in steps of 0.0001 COM
...
/**
 * CommonCoin: Default dust limit that is evaluated when considering whether a
...
/**
 * CommonCoin: Default hard dust limit that is evaluated when considering whether
