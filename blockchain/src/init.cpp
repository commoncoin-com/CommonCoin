...
void Shutdown()
{
    ...
    RenameThread("commoncoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // CommonCoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/commoncoin/commoncoin>";
    const std::string URL_WEBSITE = "<https://commoncoin.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("commoncoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("CommonCoin version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // CommonCoin: Do we need to do any RPC mining init here?
