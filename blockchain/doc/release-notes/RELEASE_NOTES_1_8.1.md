# CommonCoin Core 1.8.1

CommonCoin Core 1.8.1 is primarily a bugfix release, bringing CommonCoin Core in
line with Bitcoin 0.9.3. CommonCoin Core 1.8.1 also adds in support for printing
...
## CommonCoin Core Release Notes

* Translation improvements and corrections
* Disable Transifex based translation process (not used by CommonCoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 CommonCoin Core clients
* Use HTTPS with comchain.info
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/commoncoin/commoncoin/issues/134).
