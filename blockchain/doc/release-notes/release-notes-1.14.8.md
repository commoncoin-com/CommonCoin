CommonCoin Core version 1.14.8 is now available from:

  <https://github.com/commoncoin/commoncoin/releases/tag/v1.14.8/>

This is a new minor version release. CommonCoin users on any platform are
...
Several important updates have been added to CommonCoin Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, CommonCoin Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way CommonCoin Core
...
In previous versions of CommonCoin Core, orphan transactions were processed in a
...
CommonCoin Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in CommonCoin Core.
...
* CommonCoin Core now supports compilation with C++14 and C++17, if you select
